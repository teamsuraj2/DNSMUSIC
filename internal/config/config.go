...
func loadConfig() {
	...
	DurationLimit = int(getInt64("DURATION_LIMIT", 4200000))
	LeaveOnDemoted = getBool("LEAVE_ON_DEMOTED", false)
	QueueLimit = int(getInt64("QUEUE_LIMIT", 100))
	SupportChat = getString("SUPPORT_CHAT", "https://t.me/TwsAssociation")
	SupportChannel = getString("SUPPORT_CHANNEL", "https://t.me/TwsSupportGroup")
